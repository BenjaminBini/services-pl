...
import static com.sully.covid.util.LambertZone.*;
...
public class Lambert {
    ...
    public static LambertPoint convertToLambert(double latitude, double longitude, LambertZone zone) throws Exception {
     ...
     */
    public static LambertPoint convertToLambertByAlg003(double latitude, double longitude, LambertZone zone) throws Exception {
